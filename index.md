...
![](reference/figures/README-sotkanet_example-1.png)

For more in-depth examples, see the package vignette or online [tutorial
page](http://ropengov.github.io/sotkanet/articles/tutorial.md).
...
- [Submit suggestions and bug
  ...
  and `packageVersion("sotkanet")` and preferably provide a
