---
title: "Sotkanet API R tools (old)"
author: "Leo Lahti"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Sotkanet API R tools (old)}
...
[rOpenGov-blog](https://ropengov.org), and
[takomo](https://github.com/louhos/takomo/tree/master/Sotkanet), and 
[Helsinki Region Infoshare-blog](https://www.hri.fi/fi/ajankohtaista/sotkanet-indikaattoripankki-mukaan-sorvi-tyokalupakkiin/)
