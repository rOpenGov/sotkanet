...
Tämän `sotkanet` paketin avulla R pystyy yhdistämään Sotkanetin avoimeen rajapintaan ja käyttämään sen dataa. Paketti on kehitetty osana [rOpenGov](https://ropengov.org)-kehittäjäyhteisöä.
