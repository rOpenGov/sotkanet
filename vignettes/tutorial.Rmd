...
```{r sotkanetRegions, warning=FALSE, message=FALSE, eval=FALSE}
...
```{r sotkanetData, warning=FALSE, message=FALSE, eval=FALSE}
# Get indicator data
...
```{r sotkanetDataVisu, warning=FALSE, message=FALSE, fig.width=10, figh.height=7, eval=FALSE}
# Pick indicator name
...
```{r sotkanetVisu3, warning=FALSE, message=FALSE, eval=FALSE}
