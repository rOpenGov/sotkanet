...
```{r sotkanetDataVisu, warning=FALSE, message=FALSE, fig.width=10, figh.height=5, eval=TRUE, out.width = "100%"}
# Pick indicator name
...
```{r sotkanetVisu3, warning=FALSE, message=FALSE, eval=TRUE, fig.width=10, fig.height=5, out.width = "100%"}
