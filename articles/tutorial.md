...
#> [1] ggplot2_4.0.3    kableExtra_1.4.1 sotkanet_0.10.1 
#> 
#> loaded via a namespace (and not attached):
#>  [1] sass_0.4.10        generics_0.1.4     xml2_1.6.0         stringi_1.8.7     
#>  [5] hms_1.1.4          digest_0.6.39      magrittr_2.0.5     grid_4.6.1        
#>  [9] evaluate_1.0.5     timechange_0.4.0   RColorBrewer_1.1-3 fastmap_1.2.0     
#> [13] plyr_1.8.9         jsonlite_2.0.0     backports_1.5.1    httr_1.4.8        
#> [17] viridisLite_0.4.3  scales_1.4.0       httr2_1.3.0        bibtex_0.5.2      
#> [21] textshaping_1.0.5  jquerylib_0.1.4    cli_3.6.6          rlang_1.3.0       
#> [25] withr_3.0.3        cachem_1.1.0       yaml_2.3.12        otel_0.2.0        
#> [29] tools_4.6.1        tzdb_0.5.0         dplyr_1.2.1        frictionless_1.2.1
#> [33] curl_7.1.0         vctrs_0.7.3        R6_2.6.1           lifecycle_1.0.5   
#> [37] lubridate_1.9.5    RefManageR_1.4.0   stringr_1.6.0      fs_2.1.0          
#> [41] htmlwidgets_1.6.4  ragg_1.5.2         pkgconfig_2.0.3    desc_1.4.3        
#> [45] gtable_0.3.6       pkgdown_2.2.1      bslib_0.11.0       pillar_1.11.1     
#> [49] glue_1.8.1         Rcpp_1.1.2         systemfonts_1.3.2  tidyselect_1.2.1  
#> [53] xfun_0.60          tibble_3.3.1       rstudioapi_0.19.0  knitr_1.51        
#> [57] farver_2.1.2       htmltools_0.5.9    labeling_0.4.3     rmarkdown_2.31    
#> [61] svglite_2.2.2      readr_2.2.0        compiler_4.6.1     S7_0.2.2
```
